import {build} from 'esbuild';import {mkdir,copyFile,readdir} from 'node:fs/promises';
...
for(const pkg of ['@sendspin/sendspin-js','@scure/base','@noble/curves','@noble/hashes','@noble/ciphers','ws','opus-encdec']){
